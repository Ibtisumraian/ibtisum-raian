            ...
            <div className='flex items-center flex-col-reverse lg:flex-row lg:justify-between gap-3 '>
                ...
                <div className='flex items-center gap-3'>
                    <img
                        ...
                        src="https://res.cloudinary.com/dv6p7mprd/image/upload/v1751123062/dp001_wntiwg.png" alt="" />
                    <img
                        className='h-[300px] hidden lg:block'
                        src="https://res.cloudinary.com/dv6p7mprd/image/upload/v1751126278/my-name-removebg-preview_k5rnpe.png" alt="" />
                    {/* <img
                        className='rounded-t-full rounded-b-full max-h-[750px]'
                        src="https://res.cloudinary.com/dv6p7mprd/image/upload/v1751124116/dp001-removebg-preview_heeyvk.png" alt="" /> */}
                </div>
            </div>
        </div>
    );
